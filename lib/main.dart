...
const request = 'https://api.hgbrasil.com/finance?format=json&key=b13b1885';
        ...
        builder: (context, snapshot){
          switch (snapshot.connectionState){
            ...
            case ConnectionState.none:
              return Center(
                child: Text('Buscando dados...', style: TextStyle(
                ...
                return SingleChildScrollView(
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Divider(),
                      buildTextField('Dólar', 'US\$', dolarControler, _dolarChanged),
                      Divider(),
